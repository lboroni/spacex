        ...
        <section>
            {launch === undefined ?
                ...
                (<>
                    <Row>
                        {launch.upcoming ? (
                            <Col md={11} style={{display: 'flex', alignItems: 'center'}}>
                                ...
                                <h3 className={'ms-3'}><Badge bg="success 1rem">Upcoming</Badge></h3>
                            </Col>) : (
                            <Col md={11} style={{display: 'flex', alignItems: 'center'}}>
                                <Title title={`Mission name: ${launch.mission_name}`} className={'me-3'}/> -
                                {
                    ...
                    <p><b>Launch Date UTC: </b> {moment(launch.launch_date_utc).locale('pt').format('DD/MM/YYYY HH:mm')}
                    </p>
                    <p><b>Rocket name: </b> {rocket === undefined ? "" : rocket.name}</p>

                    <Row className='mb-4'>
                        <Col md={6} style={{maxHeight: '360px', textAlign: 'center'}}>
                            <img src={launch.links.mission_patch ? `${launch.links.mission_patch}` :
                                "https://pplware.sapo.pt/wp-content/uploads/2021/01/SpaceX-Tesmanian_1600x.jpg"}
                                 style={{maxWidth: '100%', maxHeight: '100%'}}/>
                        </Col>
                        <Col md={6}>
                            <ReactPlayer url={launch.links.video_link} controls={true}
                                         style={{maxWidth: '100%', maxHeight: '100%'}}/>
                        </Col>
                    </Row>
